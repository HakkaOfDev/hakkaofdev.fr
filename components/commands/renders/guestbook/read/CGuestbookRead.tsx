...
function CGuestbookRead() {
  ...
  return (
    <RevealSwap loading={isLoading} skeleton={<ReadSkeleton />}>
      <AnimatedSpan className="gap-2">
        {/* Header */}
        <div className="flex items-center justify-between gap-3">
          <p className="font-mono text-muted-foreground text-xs">
            <span className="font-semibold text-quinary">
              {t("headerLabel")}
            </span>
        ...
        {visible && visible.length > 0 && (
          <RevealGroup className="terminal-scrollbar max-h-52 overflow-y-auto overflow-x-hidden pr-1">
