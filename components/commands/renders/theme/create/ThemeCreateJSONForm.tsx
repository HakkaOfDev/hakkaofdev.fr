  ...
  return (
    <form onSubmit={onSubmit} className="grid max-w-md gap-2">
      ...
      <textarea
        ...
        className="terminal-scrollbar w-full resize-y rounded-md border border-border bg-muted/30 px-3 py-2 font-mono text-[11px] text-foreground outline-none placeholder:text-muted-foreground/40 focus:ring-1 focus:ring-primary/50"
        required
      />
