...
export function GitHubStarButton() {
  ...
  return (
    <Link
      ...
      className="flex h-6 select-none items-center gap-1.5 rounded-md border border-border/60 bg-muted/40 px-2 font-medium text-muted-foreground text-xs transition-all duration-200 hover:bg-muted/70 hover:text-foreground active:scale-95 dark:border-overlay-medium dark:bg-overlay-subtle dark:hover:bg-overlay-medium"
    >
