...
export const MAN_PAGES: Record<string, ManPage> = {
  ...
  stats: {
    name: "stats",
    synopsis: "Coding activity, GitHub & visitor analytics",
    usage:
      "stats [countries | browsers | referrers | trend] [--last 24h|7d|30d|90d|all]",
    examples: [
      "stats",
      "stats --last 7d",
      "stats countries",
      "stats referrers --last 30d",
      "stats trend --last 90d",
      "stats browsers --last 30d",
    ],
  ...
  "stats countries": {
    ...
    synopsis: "Visitor breakdown by country",
    usage: "stats countries [--last <range>]",
    examples: ["stats countries", "stats countries --last 30d"],
    descriptionSlug: "statsCountries",
    seeAlso: ["stats"],
  },
  "stats browsers": {
    name: "stats browsers",
    synopsis: "Browser breakdown for unique visitors",
    usage: "stats browsers [--last <range>]",
    examples: ["stats browsers", "stats browsers --last 7d"],
    descriptionSlug: "statsBrowsers",
    seeAlso: ["stats"],
  },
  "stats referrers": {
    name: "stats referrers",
    synopsis: "Top referrer hosts ranked by unique visitors",
    usage: "stats referrers [--last <range>]",
    examples: ["stats referrers", "stats referrers --last 30d"],
    descriptionSlug: "statsReferrers",
    seeAlso: ["stats"],
  },
  "stats trend": {
    name: "stats trend",
    synopsis: "Daily visitor sparkline over a time window",
    usage: "stats trend [--last <range>]",
    examples: [
      "stats trend",
      "stats trend --last 7d",
      "stats trend --last 90d",
    ],
    descriptionSlug: "statsTrend",
    seeAlso: ["stats"],
  },
  theme: {
    name: "theme",
